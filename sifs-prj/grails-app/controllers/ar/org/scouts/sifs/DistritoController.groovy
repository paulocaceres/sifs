...
class DistritoController {
    ...
    def delete(Distrito distritoInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'Distrito.label', default: 'Distrito'), distritoInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'distritoInstance.label', default: 'Distrito'), params.id])
                redirect action: "index", method: "GET"
            }
