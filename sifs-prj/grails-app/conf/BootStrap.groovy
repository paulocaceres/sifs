...
//		zona.save()
		...
		Curso curso1 = new Curso(nombre:'Modulo 1 A', descripcion:'Modulo 1 A', nivel: nivel1, cupo: 10, fecha: new Date().clearTime()).save(flush: true, insert: true)
		
		Curso curso2 = new Curso(nombre:'Modulo 1 B', descripcion:'Modulo 1 B', nivel: nivel1, cupo: 10, fecha: new Date().clearTime()+5).save(flush: true, insert: true)
		
		Curso curso3 = new Curso(nombre:'Modulo 2', descripcion:'Modulo 2', nivel: nivel1, cupo: 10, fecha: new Date().clearTime()+5).save(flush: true, insert: true)
		
		Curso curso4 = new Curso(nombre:'Modulo 3', descripcion:'Modulo 3', nivel: nivel1, cupo: 10, fecha: new Date().clearTime()+5).save(flush: true, insert: true)
		
		Curso curso5 = new Curso(nombre:'Modulo 4', descripcion:'Modulo 4', nivel: nivel2, cupo: 10, fecha: new Date().clearTime()+5).save(flush: true, insert: true)
		
		Curso curso6 = new Curso(nombre:'Modulo 5', descripcion:'Modulo 5', nivel: nivel2, cupo: 10, fecha: new Date().clearTime()+1).save(flush: true, insert: true)
		
		Curso curso7 = new Curso(nombre:'Modulo 6 G', descripcion:'Modulo 6 G', nivel: nivel2, cupo: 0, fecha: new Date().clearTime()+5).save(flush: true, insert: true)
		
		Curso curso8 = new Curso(nombre:'Modulo 6 E', descripcion:'Modulo 6 E', nivel: nivel2, fecha: new Date().clearTime()+5).save(flush: true, insert: true)
