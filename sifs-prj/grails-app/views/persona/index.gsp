		...
		<div id="list-persona" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="bloqueado" title="${message(code: 'persona.bloqueado.label', default: 'Bloqueado')}" />
					
						<th><g:message code="persona.direccion.label" default="Direccion" /></th>
				...
				<g:each in="${personaInstanceList}" status="i" var="personaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatBoolean boolean="${personaInstance.bloqueado}" /></td>
					
						<td>${fieldValue(bean: personaInstance, field: "direccion")}</td>
					
						<td>${fieldValue(bean: personaInstance, field: "documentoNumero")}</td>
