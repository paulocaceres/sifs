...
<html>
	...
	<body>
		<a href="#create-planCurso" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-planCurso" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:planCursoInstance, action:'save']" >
				<fieldset class="form">
