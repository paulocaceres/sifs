                    ...
                    <g:hasErrors bean="${contactFormInstance}">
                        ...
                        onLoaded="displayResponse('createContactForm')">
                            <fieldset>
                                ...
                                <p><label for="yourEmailAddress"><g:message code="uk.co.anthonycampbell.grails.contactform.ContactForm.yourEmailAddress.label" default="Your Email Address" />:</label><br/>
                                <g:remoteText id="yourEmailAddress" name="yourEmailAddress" paramName="yourEmailAddress" action="validate" update="yourEmailAddressFlash" maxlength="250" value="${contactFormInstance?.yourEmailAddress}" /> 
                                <span id="yourEmailAddressFlash">
                                ...
                                <p><label for="message"><g:message code="uk.co.anthonycampbell.grails.contactform.ContactForm.message.label" default="Message" />:</label><br/>
                                <g:remoteArea id="message" name="message" paramName="message" action="validate" update="messageFlash" cols="40" rows="5" value="${contactFormInstance?.message}" /> 
                                <span id="messageFlash">
                                	<g:displayFieldError bean="${contactFormInstance}" field="message">${it}</g:displayFieldError>
                                </span></p>
    
                                <p><label for="captcha"><g:message code="uk.co.anthonycampbell.grails.contactform.ContactForm.captcha.label" default="Captcha" />:</label><br/>
                                <g:remoteText id="captcha" name="captcha" paramName="captcha" action="validate" update="captchaFlash" maxlength="25" value="${contactFormInstance?.captcha}" /> 
                                <span id="captchaFlash">
                                	<g:displayFieldError bean="${contactFormInstance}" field="captcha">${it}</g:displayFieldError></span></p>
                                <p><jcaptcha:jpeg name="captchaImage" height="60px" width="210px" /></p>
    
                                <p><input id="submit" class="button" type="submit" name="submit" value="${message(code: 'default.button.send.label', default: 'Enviar')}" />
                                   <input id="reset" class="button" type="reset" name="reset" value="${message(code: 'default.button.reset.label', default: 'Borrar')}" /></p>
                            </fieldset>
                        </g:formRemote>
                    </div>
