		...
		<div id="list-nivel" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nivelCol" title="${message(code: 'nivel.nivelCol.label', default: 'Nivel Col')}" />
				...
				<g:each in="${nivelInstanceList}" status="i" var="nivelInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${nivelInstance.id}">${fieldValue(bean: nivelInstance, field: "nivelCol")}</g:link></td>
					
						<td>${fieldValue(bean: nivelInstance, field: "nombre")}</td>
