...
class CursoSpec {
    ...
    void testToString() {
		...
		assertEquals 'unNombre, unaDescripcion, 31/12/2014, unNombre, unNombre, unaDescripcion, 1, unNombre, null, unDocumentoNumero, unNombre, unApellido, unMail, unaDireccion, unaDescripcion, false, unNombre, unNivelCol, unNombre, 31/12/2014, 10', unCurso.toString()
    }
